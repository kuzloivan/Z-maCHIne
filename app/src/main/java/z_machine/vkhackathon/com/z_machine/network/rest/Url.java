...
public class Url {
    ...
    static final String PLACES = "public-api/v1/places/?fields=images,id,title,short_title,address&location=spb&lang=en&page_size=100";
    static final String PLACE = "/public-api/v1/places/{id}/?lang=en";
    static final String EVENTS_BY_PLACE = "/public-api/v1/events/";
